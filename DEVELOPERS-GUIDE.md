...
### Usable URLs ###
  ...
  - **API** - http://localhost:1358/test
  - **DB Interface** - http://localhost:1358/dbshell
  - **Java Class Browser** - http://localhost:1358/doc
...
### Testing ###
  ...
  - all API calls can be tested manually from the auto-generated http://localhost:1358/test page
